...
public class Application {
	...
	private static List<Aluno> criarAlunos() {
		...
		alunos.add(criarAluno("Ulysses Duarte Neves de Barros","UlyssesBarros",2015, Semestre.SEGUNDO));
		alunos.add(criarAluno("Leandro Cassio da Silva Braz","leandroBraz",2015, Semestre.SEGUNDO));
		return alunos;
